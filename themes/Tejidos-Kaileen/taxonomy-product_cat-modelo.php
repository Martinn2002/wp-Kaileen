...
<main>
    <div class="categorias-slider">
        <ul class="cat-tabs">
            <li><button class="cat-btn active" data-target="todos">Todos</button></li>
            <li><button class="cat-btn" data-target="chaleco"><h3>Chalecos</h3></button></li>
            <li><button class="cat-btn" data-target="polera"><h3>Poleras</h3></button></li>
            <li><button class="cat-btn" data-target="gorrito"><h3>Gorritos</h3></button></li>
            <li><button class="cat-btn" data-target="bufanda"><h3>Bufandas</h3></button></li>
            <li><button class="cat-btn" data-target="cuello"><h3>Cuellos</h3></button></li>
        </ul>   
    </div>
            ...
            <?php while ( have_posts() ) : the_post(); 
                ...
                if ($terms && !is_wp_error($terms)) {
                    foreach ($terms as $term) {
                        if ($term->slug === 'modelo') continue; // saltar categoría modelo
                        $cats[] = 'cat-' . $term->slug;
                    }
                }
            ?>
